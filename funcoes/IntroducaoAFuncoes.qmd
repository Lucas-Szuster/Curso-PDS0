...
| **Processamento**                | As instruções internas que a função executa com esses dados   |
| **Saída** / **Retorno**           | O valor que a função devolve (ou nada, se não houver retorno) |
...
| Conceito                  | Descrição                                                        |
| ------------------------- | ---------------------------------------------------------------- |
| **Parâmetro(s)/Entrada**  | O(s) valor(es) que você quer exibir (ex: uma string ou variável) |
...
| Conceito                  | Descrição                                                            |
| ------------------------- | -------------------------------------------------------------------- |
| **Parâmetro(s)/Entrada**  | O texto exibido para o usuário (ex: uma pergunta ou mensagem)        |
...
| Conceito                  | Descrição                                           |
| ------------------------- | --------------------------------------------------- |
| **Parâmetro(s)/Entrada**  | `início`, `fim`, e `passo` (todos são opcionais)    |
