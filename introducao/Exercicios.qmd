...
1. Aproximação do número $e$ usando a Série de Taylor
...
* Quando o número de termos é 1, a soma é definida como:
  ...
  $$
  \sum_{n = 0}^{1} \frac{1}{n!} = \frac{1}{0!} = \frac{1}{1} = 1
  $$
...
* Quando o número de termos é 2, a soma é definida como:
  ...
  $$
  \sum_{n = 0}^{2} \frac{1}{n!} = \frac{1}{0!} + \frac{1}{1!} = \frac{1}{1} + \frac{1}{1} = 1 + 1 = 2
  $$
